...
gameScene_maleToilet2::gameScene_maleToilet2()
{
...
void gameScene_maleToilet2::Update(float eTime) {
...
void gameScene_maleToilet2::Render() {
	ZeroIScene::Render();
	background->Render();
	portal1->Render();
	player->Render();
...
void gameScene_maleToilet2::PlayerUpdate(float eTime) {
	player->Update(eTime);
...
void gameScene_maleToilet2::SetCameraPos() {
