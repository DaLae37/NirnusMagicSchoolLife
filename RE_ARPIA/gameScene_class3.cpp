...
gameScene_class3::gameScene_class3()
{
...
void gameScene_class3::Update(float eTime) {
...
void gameScene_class3::SetCameraPos() {
...
void gameScene_class3::PlayerUpdate(float eTime) {
	player->Update(eTime);
